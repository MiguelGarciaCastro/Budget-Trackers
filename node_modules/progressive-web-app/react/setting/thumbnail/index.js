  ...
  _createClass(Thumbnail, [{
    ...
    value: function receiveFile(e) {
      ...
      reader.onload = function (e) {
        _this2.setState({
          'post_thumbnail_url': e.target.result
        });
      };
    ...
    value: function render() {
      ...
      var post_thumbnail_url = this.state.post_thumbnail_url;
      return _react["default"].createElement("div", {
        className: "thumbnail_insert_module"
      ...
      }, post_thumbnail_url ? 'Change' : 'Select', " Image"));
    }
  }]);
